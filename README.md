...
See also the Roman Coronagraph Exposure Time Calculator [corgietc](https://github.com/roman-corgi/corgietc/)
...
* Obsolete requirements (Phase B) and previous versions of Roman Coronagraph predictions are available for reference only
...
Thanks for your help! Please submit all pull requests to the `develop` branch. 
